...
function BackToStart (props) {
 ...
 class InteractiveWindow extends React.Component {
  ...
  currentWindow () {
    ...
    if (stage === 1) innerComponent = <WelcomeScreen stage={stage} onUpdate={this.props.increaseStage}/>
    else if (stage === 2) innerComponent = <Pinpad stage={stage} onUpdate={this.props.increaseStage}/>
    else if (stage === 3) innerComponent = <Amount stage={stage} onUpdate={this.props.increaseStage}/>
